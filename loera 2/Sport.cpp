...
static string biathDesc = "Women's Biathalon. Combining Cross country ski with target shooting. Rankings are a composite of shooting percentage and average rank on the ski part.";
static string biathDate = "2/10 - 2/14/2022";
...
static string skateDesc = "Women's Single Olympic Figure Skating. Scoring is based on the new composite standard.";
static string skateDate = "Week of 2/14/2022";
...
int Figure_Skating::removeByName(const std::string& key)
{
  for(auto pos = athletes.begin();pos != athletes.end();++pos){
    if((Athlete)*pos == Athlete(key,key,0)){
      athletes.erase(pos);
      return 1;
    }
  }
...
static string bobDesc = "Womens' Mono Boblsed Event";
static string bobDate = "Evening of 2/28/2022";
